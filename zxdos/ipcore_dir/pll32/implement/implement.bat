...
xst -ifn xst.scr
move pll32_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pll32_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pll32_exdes.ucf pll32_exdes

echo 'Running map'
map -timing -pr b pll32_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm pll32_exdes -w routed.ncd routed.vhd
cd ..
