...
xst -ifn xst.scr
move pll56_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pll56_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pll56_exdes.ucf pll56_exdes

echo 'Running map'
map -timing -pr b pll56_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm pll56_exdes -w routed.ncd routed.vhd
cd ..
